...
@section('content')
  <div class="form-container">
    <form action="/admin/{{$name_course}}/{{$name_chapter}}/{{$name_lesson}}/edit" enctype="multipart/form-data" method="post" >
      <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Name lesson</label>
        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="lesson_name" value="{{$lesson->lesson_name}}">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="file" class="form-control" id="formFile" name="lesson_video">
      </div>
